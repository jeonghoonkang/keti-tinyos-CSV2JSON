...
def changeJsonStr(_rename_field, _oldstr, _newstr):
    # to use progress bar
    filePerCount =0
    ...
    path_dir = directory+'/originalCSVData/sw_make'
    file_list = []
    recursive_search_dir(path_dir, file_list)
    #print(file_list)
    ...
    for file_name in file_list:
        ...
        with open(file_name, "rb") as fin:
            subdir_list = file_name.split('/originalCSVData/sw_make/resultData/')[1]
...
if __name__ == '__main__':
    ...
    changeJsonStr(str_change, old_str, new_str)
    print('\n')
